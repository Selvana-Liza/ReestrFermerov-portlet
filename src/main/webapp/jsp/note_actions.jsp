...
Fermer fermer = (Fermer)row.getObject();
%>

<liferay-ui:icon-menu>
<portlet:renderURL var="editURL">
            <portlet:param name="fermerId"
                value="<%= String.valueOf(fermer.getFermerId()) %>" />
        ...
        <liferay-ui:icon image="folder_full_document" message="Rut/Get archive" url="<%=archiveURL.toString() %>" />
