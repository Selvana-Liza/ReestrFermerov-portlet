...
public class RayonWrapper implements Rayon, ModelWrapper<Rayon> {
    ...
    */
    ...
    @Override
    public int compareTo(com.liferay.reestrFermerov.model.Rayon rayon) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.liferay.reestrFermerov.model.Rayon> toCacheModel() {
        return _rayon.toCacheModel();
    }

    @Override
    public com.liferay.reestrFermerov.model.Rayon toEscapedModel() {
        return new RayonWrapper(_rayon.toEscapedModel());
    }

    @Override
    public com.liferay.reestrFermerov.model.Rayon toUnescapedModel() {
