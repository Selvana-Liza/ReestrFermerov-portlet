...
import com.liferay.reestrFermerov.NoSuchRayonException;
import com.liferay.reestrFermerov.model.Rayon;
import com.liferay.reestrFermerov.model.impl.RayonImpl;
import com.liferay.reestrFermerov.model.impl.RayonModelImpl;
...
public class RayonPersistenceImpl extends BasePersistenceImpl<Rayon>
    ...
    protected TableMapper<Rayon, com.liferay.reestrFermerov.model.Fermer> rayonToFermerTableMapper;
    ...
    protected Rayon removeImpl(Rayon rayon) throws SystemException {
        ...
        rayonToFermerTableMapper.deleteLeftPrimaryKeyTableMappings(rayon.getPrimaryKey());
    ...
    @Override
    public Rayon updateImpl(com.liferay.reestrFermerov.model.Rayon rayon)
        throws SystemException {
        rayon = toUnwrappedModel(rayon);
     ...
     */
    @Override
    public List<com.liferay.reestrFermerov.model.Fermer> getFermers(long pk)
        throws SystemException {
        return getFermers(pk, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
    }
    ...
    public List<com.liferay.reestrFermerov.model.Fermer> getFermers(long pk,
        ...
        return getFermers(pk, start, end, null);
    }
    ...
    public List<com.liferay.reestrFermerov.model.Fermer> getFermers(long pk,
        ...
        throws SystemException {
        return rayonToFermerTableMapper.getRightBaseModels(pk, start, end,
            orderByComparator);
    }
     ...
     */
    @Override
    public int getFermersSize(long pk) throws SystemException {
        long[] pks = rayonToFermerTableMapper.getRightPrimaryKeys(pk);
    ...
    public boolean containsFermer(long pk, long fermerPK)
        throws SystemException {
        return rayonToFermerTableMapper.containsTableMapping(pk, fermerPK);
    }
     ...
     */
    @Override
    public boolean containsFermers(long pk) throws SystemException {
        if (getFermersSize(pk) > 0) {
            return true;
        } else {
            return false;
        }
     ...
     */
    @Override
    public void addFermer(long pk, long fermerPK) throws SystemException {
        rayonToFermerTableMapper.addTableMapping(pk, fermerPK);
    }
    ...
    public void addFermer(long pk,
        ...
        throws SystemException {
        rayonToFermerTableMapper.addTableMapping(pk, fermer.getPrimaryKey());
    }
     ...
     */
    @Override
    public void addFermers(long pk, long[] fermerPKs) throws SystemException {
        for (long fermerPK : fermerPKs) {
            rayonToFermerTableMapper.addTableMapping(pk, fermerPK);
        }
    }
    ...
    public void addFermers(long pk,
        List<com.liferay.reestrFermerov.model.Fermer> fermers)
        throws SystemException {
        for (com.liferay.reestrFermerov.model.Fermer fermer : fermers) {
            rayonToFermerTableMapper.addTableMapping(pk, fermer.getPrimaryKey());
        }
    }
     ...
     */
    @Override
    public void clearFermers(long pk) throws SystemException {
        rayonToFermerTableMapper.deleteLeftPrimaryKeyTableMappings(pk);
    }
     ...
     */
    @Override
    public void removeFermer(long pk, long fermerPK) throws SystemException {
        rayonToFermerTableMapper.deleteTableMapping(pk, fermerPK);
    }
    ...
    public void removeFermer(long pk,
        com.liferay.reestrFermerov.model.Fermer fermer)
        throws SystemException {
        rayonToFermerTableMapper.deleteTableMapping(pk, fermer.getPrimaryKey());
    }
    ...
    public void removeFermers(long pk,
        ...
        throws SystemException {
        for (com.liferay.reestrFermerov.model.Fermer fermer : fermers) {
            rayonToFermerTableMapper.deleteTableMapping(pk,
                fermer.getPrimaryKey());
        }
    }
     ...
     */
    @Override
    public void setFermers(long pk, long[] fermerPKs) throws SystemException {
        Set<Long> newFermerPKsSet = SetUtil.fromArray(fermerPKs);
        Set<Long> oldFermerPKsSet = SetUtil.fromArray(rayonToFermerTableMapper.getRightPrimaryKeys(
                    pk));

        Set<Long> removeFermerPKsSet = new HashSet<Long>(oldFermerPKsSet);

        removeFermerPKsSet.removeAll(newFermerPKsSet);

        for (long removeFermerPK : removeFermerPKsSet) {
            rayonToFermerTableMapper.deleteTableMapping(pk, removeFermerPK);
        }

        newFermerPKsSet.removeAll(oldFermerPKsSet);

        for (long newFermerPK : newFermerPKsSet) {
            rayonToFermerTableMapper.addTableMapping(pk, newFermerPK);
        }
    }
    ...
    public void setFermers(long pk,
        ...
        throws SystemException {
        try {
            long[] fermerPKs = new long[fermers.size()];

            for (int i = 0; i < fermers.size(); i++) {
                com.liferay.reestrFermerov.model.Fermer fermer = fermers.get(i);

                fermerPKs[i] = fermer.getPrimaryKey();
            }

            setFermers(pk, fermerPKs);
        } catch (Exception e) {
            throw processException(e);
        } finally {
            FinderCacheUtil.clearCache(RayonModelImpl.MAPPING_TABLE_RR_FERMERS_RAYONS_NAME);
        }
    }
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.liferay.reestrFermerov.model.Rayon")));
        ...
        rayonToFermerTableMapper = TableMapperFactory.getTableMapper("RR_Fermers_Rayons",
                "rayonId", "fermerId", this, fermerPersistence);
    }
    ...
    public void destroy() {
        ...
        TableMapperFactory.removeTableMapper("RR_Fermers_Rayons");
    }
}
